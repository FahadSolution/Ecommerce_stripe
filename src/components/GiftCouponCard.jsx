        ...
        >
            <div className="space-y-4">
                <div>
                    ...
                    p-2 text-sm text-white placeholder-gray-400 focus:border-emerald-500
            ...
            {isCouponApplied && coupon &&(
                <div className="mt-4">
                    <h3 className="text-lg font-medium text-gray-300">
                        ...
                        <motion.button
                        type="button"
                        className="mt-2 w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2 text-sm
                        font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-red-300"
                        whileTap={{scale:0.95}}
                        whileHover={{scale:1.05}}
                        onClick={handleRemoveCoupon}
                        >Remove Coupon</motion.button>
                </div>
            ...
            {coupon && (
                <div className="mt-4">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        {coupon.code} - {coupon.discountPercentage}% off</p>
                </div>
            )}
        </motion.div>
    )
