  ...
  const handleImageChange = (e)=>{
    ...
    return(
        <motion.h1
                ...
                >
                    <div className="text-2xl font-semibold mb-6 text-emerald-300">Create New Product</div>
                    <form  className="space-y-4" onSubmit={handleSubmit}>
                        <div>
                            ...
                            className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-2 text-white
                        ...
                        <div className="mt-1 flex items-center">
                            ...
                            loading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:outline-none focus:ring-2 focus:ring-offset-2
                        ...
                        >
                            {loading ? (
                                <>
                                <Loader className="mr-5 h-5 animate-spin" aria-hidden='true'/>
                                Loading...
                                </>
                            ):(
                                <>
